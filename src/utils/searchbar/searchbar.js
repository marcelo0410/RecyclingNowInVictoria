  ...
  render() {
    return (
      <div>
        <div class="wrapper">
          <div class="searchBar">
            <input id="searchQueryInput" type="text" name="searchQueryInput" placeholder="Enter waste's catagory or key word" value={this.state.searchText} onChange={this.updateInputValue} onKeyUp={this.handleEnterKey}/>
