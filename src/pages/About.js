...
export default function About() {
  return (
    <div>
        ...
        <div id="desc" style={{marginTop:"30px", marginLeft:"45px", marginRight:"15px", textAlign:"left", backgroundColor:"#EDEDED"}}>
            <div style={{paddingTop:"30px", paddingLeft:"20px", paddingRight:"20px", paddingBottom:"20px"}}>
                <h3>What is RecycleNowInVictroia?</h3>
                <p>RecycleNowInVictroia is an environmental friendly project. We urge people reduce the contaimination of disposalbles and propagate people the importance of waste classification.<br/><br/></p>
                <h3>Disclaimer</h3>
